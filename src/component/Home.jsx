        ...
        >
          <div className="flex  flex-col sm:flex-row px-6 sm:px-30 gap-6 sm:gap-44 sm:items-start">
            <div className="md:mt-10 mt-0">
              ...
              <button className="bg-[#e32040] md:mt-8 mt-6 border-2 border-[#e32040] hover:bg-white hover:text-red-600 cursor-pointer text-lg sm:text-xl rounded-full p-3 font-bold text-white">
            ...
            <div>
              <h1 className="flex md:gap-2 gap-6 md:mt-20 mt-4">
